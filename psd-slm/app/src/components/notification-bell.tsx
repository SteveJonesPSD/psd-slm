  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-2.5 w-full rounded-lg px-3.5 py-2.5 text-sm transition-colors text-slate-500 hover:text-slate-300 hover:bg-slate-800/50 ${
